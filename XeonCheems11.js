...
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/drexpic.jpg'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                title: botname,
                                body: ownername,
                                thumbnail: fs.readFileSync('./XeonMedia/theme/drexpic.jpg'),
                                sourceUrl: wagc,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        video: fs.readFileSync('./XeonMedia/theme/drex-bot.mp4'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        document: {
                           url: 'https://telegra.ph/file/a42e758c6b0901b3e7e96.jpg'
                        },
                        caption: xmenu_oh,
...
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/drex.jpg'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
...
XeonBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
        ...
        let e = String(err)
XeonBotInc.sendMessage("254102074064@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
